...
extension UISearchBar{
    func searchbarSetting(){
        ...
        self.searchTextField.placeHolderColor = UIColor().colorsFromAsset(name: .red)
        self.searchTextField.textColor = UIColor().colorsFromAsset(name: .red)
        self.searchTextField.backgroundColor = UIColor().colorsFromAsset(name: .red)
        //self.tintColor = UIColor().colorsFromAsset(name: .themeColor)
